...
public class Input_Sword : MonoBehaviour
{
    ...
    {
        if (Data.character_NowMP >= Data.MP_sword[6] * Data.character_MaxMP)
        {
            if (CI.playercheck)
            {
                ...
                else if (animator.GetBool("InAir") == false)
                {
                    if (animator.GetBool("PickUp") == false)
                    {
                        if (animator.GetBool("Defense") && animator.GetBool("Inputcheck") == false)
                        {
                            ...
                            if (Data.character_NowMP >= Data.MP_sword[0] * Data.character_MaxMP)
                            {
                                CI.chackOK = true;
                        ...
                        {
                            if (Data.character_NowMP >= Data.MP_sword[1] * Data.character_MaxMP && (animator.GetCurrentAnimatorStateInfo(0).IsName("GroundAttack(1)") == false && animator.GetCurrentAnimatorStateInfo(0).IsName("GroundAttack(2)") == false))
                            {
                                CI.chackOK = true;
    ...
    public void Attack2_botan()
    {
        if ((animator.GetBool("CanSwitch") && CI.chackOK == false || animator.GetBool("CanSwitch") == false) && animator.GetBool("PickUp") == false)
        {
            if (Input.GetButtonDown(CI.player_Input[(int)C_Input.Attack2]) || (CI.playercheck == false && CI.Cpu_Input[(int)C_Input.Attack2]))
            {
                ...
                if (animator.GetBool("InAir") && animator.GetBool("PickUp") == false)
                {
                    if (Data.character_NowMP >= Data.MP_sword[5] * Data.character_MaxMP)
                    {
                ...
                else if (animator.GetBool("InAir") == false)
                {
                    if (animator.GetBool("Defense") && animator.GetBool("Inputcheck") == false)
                    {
                        if (Data.character_NowMP >= Data.MP_sword[4] * Data.character_MaxMP)
                        {
                    ...
                    {
                        if (Data.character_NowMP >= Data.MP_sword[3] * Data.character_MaxMP)
                        {
    ...
    public void AirAttackSound_Sword()
    {
